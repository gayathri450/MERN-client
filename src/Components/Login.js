...
import { FormContext } from "./Register"; // Assuming FormContext is defined in Register.js
import '../index.css'; // Assuming you have a CSS file for styling

export default function Login() {
  const [localDB] = useContext(FormContext); // Accessing context data from Register.js
  const [login, setLogin] = useState(""); // State to manage login success/failure message
